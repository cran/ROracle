...
/*
  ...
  MODIFIED
    rdecker    12/19/23 - Project 100172: Vector support
    jmmedina   01/12/21 - Add support for associative arrays on the client
    snechand   06/20/19 - Bug 29805038: OCI_DURATION_FETCH added
    skabraha   01/10/19 - Support for JSON datatype
...
#define  OCI_DURATION_FETCH (OCIDuration)(OCI_DURATION_BEGIN+5)

#define  OCI_DURATION_LAST OCI_DURATION_FETCH
...
#define OCI_TYPECODE_ASSOC_ARRAY 290             /* PL/SQL ASSOCIATIVE ARRAY */
...
/* Oracle 20: Adding JSON data type */
#define OCI_TYPECODE_JSON       SQLT_JSON

/* Oracle 23: Adding VECTOR data type */
#define OCI_TYPECODE_VECTOR     SQLT_VEC
