...
class MetaData
{
  public :
      ...
      ATTR_VECTOR_DIMENSION = OCI_ATTR_VECTOR_DIMENSION,
      ATTR_VECTOR_DATA_FORMAT = OCI_ATTR_VECTOR_DATA_FORMAT,
      ATTR_VECTOR_PROPERTY = OCI_ATTR_VECTOR_PROPERTY
     };
...
class Statement 
{
 public:
  ...
  virtual void setInt8Vector(unsigned int paramIndex,
                             OCCI_STD_NAMESPACE::vector<int8_t>&vec) = 0;

  virtual void setFloatVector(unsigned int paramIndex,
                              OCCI_STD_NAMESPACE::vector<float>&vec) = 0;

  virtual void setDoubleVector(unsigned int paramIndex,
                               OCCI_STD_NAMESPACE::vector<double>&vec) = 0;

  virtual void setBinaryVector(unsigned int paramIndex,
                               OCCI_STD_NAMESPACE::vector<uint8_t>&vec) = 0;

  virtual void getInt8Vector(unsigned int paramIndex,
                             OCCI_STD_NAMESPACE::vector<int8_t>&vec) = 0;

  virtual void getFloatVector(unsigned int paramIndex,
                              OCCI_STD_NAMESPACE::vector<float>&vec) = 0;

  virtual void getDoubleVector(unsigned int paramIndex,
                               OCCI_STD_NAMESPACE::vector<double>&vec) = 0;

  virtual void getBinaryVector(unsigned int paramIndex,
                               OCCI_STD_NAMESPACE::vector<uint8_t>&vec) = 0;
...
class ResultSet 
{
 public:
  ...
  virtual void getInt8Vector(unsigned int colIndex,
                             OCCI_STD_NAMESPACE::vector<int8_t>&vec) = 0;

  virtual void getFloatVector(unsigned int colIndex,
                              OCCI_STD_NAMESPACE::vector<float>&vec) = 0;

  virtual void getDoubleVector(unsigned int colIndex,
                               OCCI_STD_NAMESPACE::vector<double>&vec) = 0;

  virtual void getBinaryVector(unsigned int colIndex,
                               OCCI_STD_NAMESPACE::vector<uint8_t>&vec) = 0;
