...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   ffocilme    09/17/24 - Bug 36943240: Fix ODCI standardized flags
   ffocilme    08/07/24 - Bug 36878894: Add predefined integer types 
   youjuki     12/07/23 - Bug 36061070: Add ODCI_EXTTABLE_FETCH_RESET_RJCT
   richen      04/01/23 - BUG 35999032: Enable XAD config to switch from loader
                          to bigdata
...
typedef ub2 ODCIQueryInfoFlags;
...
typedef ub4 ODCIStatsOptionsFlags;
...
typedef ub2 ODCIIndexInfoFlags;
...
#define ODCI_EXTTABLE_INFO_FLAG_NO_REF_COL       0x00000010
    /* set if switched from ORACLE_LOADER to ORACLE_BIGDATA XAD */
#define ODCI_EXTTABLE_INFO_FLAG_LOADER_TO_BIGDATA 0x00000020

typedef ub4 ODCIExtTableInfoFlag;
...
typedef ub4 ODCIExtTableOpenFlags;
...
struct ODCITrustedColInfo
{
 ...
 ODCIColInfoFlags ColFlags;          /* QX_CINFO_FLAGS_POS */
...
struct ODCITrustedIndexInfo
{
   ...
   ODCIIndexInfoFlags     IndexInfoFlags;
   ub2                    IndexParaDegree;
